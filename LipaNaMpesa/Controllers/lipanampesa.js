...
// Define initiateSTKPush as a regular function
const initiateSTKPush = (req, res) => {
    try {
        ...
        // ngrok connection is asynchronous, so we need to await it
        (async () => {
            ...
            request({
                ...
                json: {
                    ...
                    "AccountReference": "MUKESA ACCOUNT",
